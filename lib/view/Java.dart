            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      "lib/assets/imagens/logo_java.png",
                      width: 60,
                      height: 60,
                      fit: BoxFit.contain,
                    ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text(
                        "Linguagem orientada a objetos, muito usada no mundo corporativo e conhecida pela portabilidade (funciona em qualquer sistema com a JVM).\n\nPrincipais aplicações:\n- Aplicações empresariais \n- Apps Android \n- Sistemas bancários \n- Backend de sites e APIs \n- Jogos (ex.: com a biblioteca LibGDX)",
                        textAlign: TextAlign.center,
                      ...
                      Image.asset(
                          "lib/assets/imagens/Código-Java.png",
                          fit: BoxFit.contain,
                      ),
                    ],
                  ),
