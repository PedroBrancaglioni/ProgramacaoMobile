...
class CMaisMais extends StatelessWidget {
  const CMaisMais({super.key});
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text(
                        "Extensão da linguagem C, adicionando orientação a objetos. É rápida, eficiente e muito usada em aplicações de alto desempenho.\n\nPrincipais aplicações:\n- Jogos \n- Sistemas operacionais \n- Softwares embarcados \n- Aplicativos que exigem alta performance (ex.: simuladores)",
                        textAlign: TextAlign.center,
