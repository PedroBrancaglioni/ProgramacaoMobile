            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      "lib/assets/imagens/logo_python.png",
                      width: 60,
                      height: 60,
                      fit: BoxFit.contain,
                    ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text(
                        "Python é uma linguagem de programação simples e fácil de aprender, criada para ser clara e prática. Ela é multiparadigma (suporta programação estruturada, orientada a objetos e funcional) e tem uma grande comunidade, o que garante muitas bibliotecas e ferramentas prontas.\n\nAplicações: \n- Desenvolvimento web \n- Análise de dados e inteligência artificial \n- Automação de tarefas \n- Ciência e pesquisa \n- Desenvolvimento de jogos e aplicativos \n- Internet das Coisas (IoT) e robótica \n- Aplicações desktop",
                        textAlign: TextAlign.center,
                      ...
                      Image.asset(
                          "lib/assets/imagens/Código-Python.png",
                          fit: BoxFit.contain,
                      ),
                    ],
                  ),
